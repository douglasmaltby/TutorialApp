...
public class Comsapedmsampleservicev2OnlineODataController: ODataControlling {
    private let logger = Logger.shared(named: "Comsapedmsampleservicev2OnlineODataController")
