...
class StockMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([Stock]?, Error?) -> Void) -> Void)?
    private var entities: [Stock] = [Stock]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let stock = self.entities[indexPath.row]
...
extension StockMasterViewController: Comsapedmsampleservicev2EntitySetUpdaterDelegate {
