...
class ProductTextDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private func cellForId(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForLanguage(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForLongDescription(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForName(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForProductID(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForShortDescription(tableView: UITableView, indexPath: IndexPath, currentEntity: ProductText, property: Property) -> UITableViewCell {
        var value = ""
...
extension ProductTextDetailViewController: Comsapedmsampleservicev2EntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! ProductText
