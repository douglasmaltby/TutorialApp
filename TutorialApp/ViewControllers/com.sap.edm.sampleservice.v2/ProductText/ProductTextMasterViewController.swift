...
class ProductTextMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([ProductText]?, Error?) -> Void) -> Void)?
    private var entities: [ProductText] = [ProductText]()
...
extension ProductTextMasterViewController: Comsapedmsampleservicev2EntitySetUpdaterDelegate {
