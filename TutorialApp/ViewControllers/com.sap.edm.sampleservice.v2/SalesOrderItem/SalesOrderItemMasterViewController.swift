...
class SalesOrderItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([SalesOrderItem]?, Error?) -> Void) -> Void)?
    private var entities: [SalesOrderItem] = [SalesOrderItem]()
...
extension SalesOrderItemMasterViewController: Comsapedmsampleservicev2EntitySetUpdaterDelegate {
