...
class ProductDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    var entityUpdater: Comsapedmsampleservicev2EntityUpdaterDelegate?
    var tableUpdater: Comsapedmsampleservicev2EntitySetUpdaterDelegate?
    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 18:
            if !self.entity.isNew {
                ...
                self.espmContainer.loadProperty(Product.stockDetails, into: self.entity) { error in
        ...
        case 19:
            if !self.entity.isNew {
                ...
                self.espmContainer.loadProperty(Product.supplierDetails, into: self.entity) { error in
                    self.hideFioriLoadingIndicator()
                    if let error = error {
                        AlertHelper.displayAlert(with: NSLocalizedString("keyErrorLoadingData", value: "Loading data failed!", comment: "XTIT: Title of loading data error pop up."), error: error, viewController: self)
                        return
    ...
    private func cellForCategory(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForCategoryName(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForCurrencyCode(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForDimensionDepth(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForDimensionHeight(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForDimensionUnit(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForDimensionWidth(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForLongDescription(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForPictureUrl(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForQuantityUnit(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForShortDescription(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForUpdatedTimestamp(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForWeight(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForWeightUnit(tableView: UITableView, indexPath: IndexPath, currentEntity: Product, property: Property) -> UITableViewCell {
        var value = ""
...
extension ProductDetailViewController: Comsapedmsampleservicev2EntityUpdaterDelegate {
