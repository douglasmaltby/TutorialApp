...
class PurchaseOrderHeaderMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([PurchaseOrderHeader]?, Error?) -> Void) -> Void)?
    private var entities: [PurchaseOrderHeader] = [PurchaseOrderHeader]()
...
extension PurchaseOrderHeaderMasterViewController: Comsapedmsampleservicev2EntitySetUpdaterDelegate {
