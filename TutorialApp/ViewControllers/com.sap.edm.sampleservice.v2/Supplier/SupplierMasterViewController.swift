...
class SupplierMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            detailViewController.navigationItem.title = self.entities[(self.tableView.indexPathForSelectedRow?.row)!].supplierID ?? ""
...
extension SupplierMasterViewController: Comsapedmsampleservicev2EntitySetUpdaterDelegate {
